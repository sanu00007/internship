...
bool process_account_transactions(const json_t *root, int from_date,int to_date, int date_format, 
  ...
  const char* fourth_remaining = "</td><td  class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:left\">Opening Balance</td>  <td colspan=\"5\" class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:right\"><span>";
    ...
    const char* fifth_part ="</span></td><td  class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:right\"><span>";
    fwrite(fifth_part, 1, strlen(fifth_part), fp);
    ...
    const char* sixth_part ="</span></td><td  class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:right\"><span>";
    fwrite(sixth_part, 1, strlen(sixth_part), fp);
   ...
   fourth_part = "<tr mat-footer-row="" class=\"mat-footer-row cdk-footer-row \"> <td mat-footer-cell="" class=\"mat-footer-cell    \"><span class=\"font-weight-600 \"></span>";
   fwrite(fourth_part, 1, strlen(fourth_part), fp);
   snprintf(tmp_buff, 99, "%s", str_date2);
   fwrite(tmp_buff, 1, strlen(tmp_buff), fp);
   free(str_date2);
   
  fourth_remaining = "</td><td  mat-footer-cell="" class=\"mat-footer-cell    \">Closing Balance</td>  <td colspan=\"5\" style=\"text-align: right; mat-footer-cell="" class=\"mat-footer-cell  cdk-column-amount mat-column-amount \"><span class=\"font-weight-600\">";
    fwrite(fourth_remaining, 1, strlen(fourth_remaining), fp);
    total_debit+=open_bal;
    print_number_at(total_debit, currency_format, currency_symbol, fp);
    
    
     fifth_part ="</span></td><td style=\"text-align: right; mat-footer-cell="" class=\"mat-footer-cell  cdk-column-balance \"><span class=\"font-weight-600\">";
    fwrite(fifth_part, 1, strlen(fifth_part), fp);
    total_credit+=close_bal;
    print_number_at(total_credit, currency_format, currency_symbol, fp);
    
     sixth_part ="</span></td><td style=\"text-align: right; mat-footer-cell="" class=\"mat-footer-cell  cdk-column-balance \"><span class=\"font-weight-600\">";
    fwrite(sixth_part, 1, strlen(sixth_part), fp);
    total_deb_cred_amount+=initial_amount;
    print_number_at(total_deb_cred_amount, currency_format, currency_symbol, fp);
    
     last_part="</span></td></tr>";
    fwrite(last_part, 1, strlen(last_part), fp);
