...
static void print_tcs_account(json_t* node,  CurrencyFormat *currency_format,
  const char *currency_symbol, vector<data_map *> *contact_mapping, FILE *fp) {
  const char *first_part = "<tr   mat-row="" class=\"mat-row cdk-row ng-star-inserted\" style=""><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\">";   
  ...
  const char* second_part = "</span></td><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\"><span  class=\"app-link icon-hover\">";
  ...
  if(json_handle && json_is_string(json_handle)){
   ...
   const char* third_part = "</span></td><td  style=\"text-align: center; \"class=\"mat-cell\"><span  class=\"font-weight-500\">";
   ...
   const char* fourth_part = "</span></td><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\">";
   ...
   const char* fifth_part = "</span></td><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\">";
  ...
  if(json_handle && json_is_string(json_handle)){
    ...
    const char* sixth_part = "</span></td><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\">";
    ...
    const char* seventh_part = "</span></td><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\">";
    ...
    const char* eigth_part = "</span></td><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\">";
    ...
    const char* nineth_part = "</span></td><td class=\"mat-cell\" style=\"top: 0px; z-index: 100; text-align:center\">";
    fwrite(nineth_part, 1, strlen(nineth_part), fp);
    json_handle = json_object_get(node, "collection_code");
    if(json_handle && json_is_string(json_handle)){
      const char *collection_code = json_string_value(json_handle);
      fwrite(collection_code, 1, strlen(collection_code), fp);
      }
...
static void print_tcs_accnts_from_array(json_t* arr,  CurrencyFormat *currency_format, 
  const char *currency_symbol, vector<data_map *> *contact_mapping, FILE *fp){
  json_t *node;
  int index = 0;
  json_array_foreach(arr, index, node){
    if(json_is_object(node)){
      print_tcs_account(node, currency_format, currency_symbol, contact_mapping, fp);
    }
  } 
}


bool process_tcs_summary(const json_t *root, int from_date,int to_date, int date_format, 
  ...
  do{
    ...
    const char* second_part = "</h2><h2  class=\"mt-0 mb-0\">TCS Summary</h2><h4  class=\"text-muted mt-0 font-weight-normal\">";
    fwrite(second_part, 1, strlen(second_part), fp);
    ...
    const char* third_part = "</h4></div><div  class=\"report-holder wide-report-holder\"><table  mat-table="" matsort="" class=\"mat-table cdk-table mat-sort w-100\"><thead \"> <tr   mat-header-row="" class=\"mat-header-row cdk-header-row ng-star-inserted\" style=""> <th   mat-header-cell="" mat-sort-header="" class=\"mat-sort-header mat-header-cell cdk-header-cell ng-tns-c141-74 cdk-column-date mat-column-date ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" aria-sort=\"none\" style=\"top: 0px; z-index: 100;\"> <div class=\"mat-sort-header-container mat-focus-indicator ng-tns-c141-74\" aria-describedby=\"cdk-describedby-message-20\" cdk-describedby-host=\"0\" tabindex=\"0\" ><div class=\"mat-sort-header-content ng-tns-c141-74\">Date</div> <div class=\"mat-sort-header-arrow ng-trigger ng-trigger-arrowPosition ng-tns-c141-74 ng-star-inserted\" style=\"transform: translateY(25%); opacity: 0;\"> <div class=\"mat-sort-header-stem ng-tns-c141-74\"></div><div class=\"mat-sort-header-indicator ng-tns-c141-74 ng-trigger ng-trigger-indicator\" style=\"transform: translateY(0px);\"> <div class=\"mat-sort-header-pointer-left ng-tns-c141-74 ng-trigger ng-trigger-leftPointer\" style=\"transform: rotate(-45deg);\"></div> <div class=\"mat-sort-header-pointer-right ng-tns-c141-74 ng-trigger ng-trigger-rightPointer\" style=\"transform: rotate(45deg);\"></div><div class=\"mat-sort-header-pointer-middle ng-tns-c141-74\"></div> </div></div> </div></th><th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-number mat-column-number ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">Transaction#</th><th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-type mat-column-type ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">Type</th> <th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-customer_name mat-column-customer_name ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">Customer</th>  <th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-pan mat-column-pan ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">PAN</th> <th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-tcs_tds_rate mat-column-tcs_tds_rate ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">Rate</th> <th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-tcs_total mat-column-tcs_total ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">Total</th> <th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-tcs_amount mat-column-tcs_amount ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">TCS</th><th   mat-header-cell="" class=\"mat-header-cell cdk-header-cell cdk-column-collection_code mat-column-collection_code ng-star-inserted mat-table-sticky mat-table-sticky-border-elem-top\" style=\"top: 0px; z-index: 100;\">Code</th></tr></thead>";
    fwrite(third_part, 1, strlen(third_part), fp);
    ...
    if(arr_handle && json_is_array(arr_handle)){
      print_tcs_accnts_from_array( arr_handle,currency_format, 
